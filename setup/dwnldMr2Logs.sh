...
echo From $WLS_DMN_NS/$MR2_POD download $DMN_HOME/servers/$MR_SVR2/logs/$OUT_FILE to $LCL_LOGS_HOME/$OUT_FILE
kubectl cp $WLS_DMN_NS/$MR2_POD:$DMN_HOME/servers/$MR_SVR2/logs/$OUT_FILE $OUT_LOGS_HOME/$OUT_FILE